public class Ogrenci {private String ad;
    ...
    public String ogrenciNoOlustur(){
        return Integer.toString(girisYili)+bolumKodu+"015";
    }
    public double harcHesapla(int uzayanYil){
        if (2024-girisYili>4)
            return 1000;
        return 0;
    }
    public double harcHesapla(int uzayanYil,double kredi){
        if (2024-girisYili>4)
            return 1000+kredi*30;
        return 0;
    }
